  ...
  <div>
    <div class="wrap" v-show="!lotteryFlag">
      <div v-if="disBg" class="wrap_bg">
        ...
        <button v-if="start" @click="startGame" class="startGameBtn ">
          开始游戏
        </button>
        <button v-if="LotteryButtonFlag" @click="lotteryFlag = true" class="lotteryBtn">
          去抽奖
        </button>
      </div>
    ...
    <Lottery @restartFromLottery="restartRainGame" class="lottory" v-if="lotteryFlag" :phone="phone"></Lottery>
  </div>
</template>
<script>
